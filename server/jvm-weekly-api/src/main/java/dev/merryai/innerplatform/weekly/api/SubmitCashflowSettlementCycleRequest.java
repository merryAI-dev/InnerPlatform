...
public record SubmitCashflowSettlementCycleRequest(
    ...
    @NotBlank @Size(max = 160) String stageId,
    ...
    @NotBlank @Size(max = 160) String expectedApproverUid,
    @Min(0) long expectedProjectVersion
) {
    public SubmitCashflowSettlementCycleRequest {
        ...
        expectedApproverUid = normalize(expectedApproverUid);
    }
