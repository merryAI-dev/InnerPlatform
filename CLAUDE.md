...
This project is indexed by GitNexus as **InnerPlatform-ft-izzie-latest** (2371 symbols, 6896 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
