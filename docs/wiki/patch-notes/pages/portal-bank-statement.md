...
- [x] 업로드/드래그/queue 강조색이 teal 대신 navy/slate 계열로 정리됨
- [ ] 마지막 행 드롭다운 잘림 이슈 완전 해소 확인 필요

## Recent Changes

- [2026-04-14] bank statement empty state, drag 강조, queue 톤을 navy/slate 계열로 눌러 포털 홈과 같은 monochrome shell 언어로 맞췄다.
