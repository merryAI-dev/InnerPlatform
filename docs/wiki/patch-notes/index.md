...
| [portal-weekly-expense](./pages/portal-weekly-expense.md) | `/portal/weekly-expenses` | 2026-04-16 | summary read model + weekly expense command authority 첫 slice |
...
| [shared-portal-architecture](./pages/shared-portal-architecture.md) | `shared / architecture` | 2026-04-16 | finance-grade master plan, phase 0 gate, phase 2 weekly expense command authority |
...
- [portal-project-select](./pages/portal-project-select.md)
...
- 포털 플랫폼 옵션 비교: [portal-platform-options-2026-04-15.md](../../architecture/portal-platform-options-2026-04-15.md)
