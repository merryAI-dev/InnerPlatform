...
**날짜:** 2026-08-18
**상태:** Superseded — 2026-09-03 정산 사이클 계약으로 대체
**관련:** [기간 권한 계약](./2026-08-14-cashflow-period-authority.md) · [잠금 권한 후속](./2026-08-18-cashflow-close-authority-followup.md)

> **2026-09-03 계약:** 정산 사이클은 연도와 무관하게 항상 사이클월의 직전월을 월결산 대상으로 삼는다. 따라서 1월 사이클은 전년도 12월을 잠그며, 잠금 연도는 회차월이 아니라 canonical `closedThrough`에서 결정한다. 아래 내용은 이 결정 이전의 기록으로만 남긴다.
