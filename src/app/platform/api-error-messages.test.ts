...
const cases = [
  ...
  ['cashflow_month_closed', 'contact'],
  ['cashflow_month_close_contract_invalid', 'contact'],
  ['cashflow_month_reopen_decision_forbidden', 'contact'],
  ['cashflow_month_reopen_latest_horizon_only', 'retry'],
  ['cashflow_month_reopen_month_not_closed', 'contact'],
  ['cashflow_month_reopen_revision_changed', 'retry'],
  ['cashflow_month_reopen_latest_request_required', 'retry'],
  ['cashflow_month_reopen_request_missing', 'retry'],
  ['cashflow_month_reopen_not_awaiting_decision', 'retry'],
  ['cashflow_month_reopen_counter_invalid', 'contact'],
  ['cashflow_month_reopen_decision_invalid', 'contact'],
  ['cashflow_month_reopen_period_invalid', 'contact'],
