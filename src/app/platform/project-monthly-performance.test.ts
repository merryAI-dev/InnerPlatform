...
describe('buildProjectMonthlyPerformance', () => {
  it('uses the latest approved project log and a rolling KST twelve-month window', () => {
    ...
    expect(months[11]).toMatchObject({ key: '2026-07', contractAmount: 300_000, totalRevenueAmount: 75_000 });
    expect(months[10]).toMatchObject({ key: '2026-06', contractAmount: 0, totalRevenueAmount: 0 });
  });
});
