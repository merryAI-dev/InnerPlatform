...
describe('CashflowProjectSheet actual sync flow', () => {
  ...
  it('replaces the empty-row toggle with an explicit sheet refresh action', () => {
    ...
    expect(cashflowProjectSheetSource).toContain('최근 후보');
    ...
    expect(cashflowProjectSheetSource).toContain('변경 검토 열기');
    expect(cashflowProjectSheetSource).toContain('변경 검토함');
    expect(cashflowProjectSheetSource).toContain('시트 변경 가져오기');
    expect(cashflowProjectSheetSource).toContain('Projection 시트에 쓰기');
    expect(cashflowProjectSheetSource).toContain('변경 후보 만들기');
