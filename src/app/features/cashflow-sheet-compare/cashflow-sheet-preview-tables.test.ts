...
describe('cashflow sheet preview tables', () => {
  ...
  it('does not fall back to Firebase values when the sheet value is not numeric', () => {
  ...
  it('calculates totals from sheet values only while keeping Firebase values for diff context', () => {
