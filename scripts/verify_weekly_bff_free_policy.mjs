...
requireIncludes(smokeScript, '/api/v1/auth/session', 'smoke login-time session-cookie creation');
requireIncludes(smokeScript, 'cookie: sessionCookie', 'smoke session-cookie command channel');
...
requireIncludes(filter, 'verifyFirebaseActor', 'Java Firebase session or bearer authentication');
requireIncludes(filter, 'verifySessionCookie', 'Java Firebase session-cookie authentication');
