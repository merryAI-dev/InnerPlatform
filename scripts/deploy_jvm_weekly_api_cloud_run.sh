...
gcloud run deploy "$SERVICE_NAME" \
  ...
  "${NETWORK_ARGS[@]}" \
  --set-env-vars "WEEKLY_API_PORT=8080,JVM_WEEKLY_STORAGE_BACKEND=${JVM_WEEKLY_STORAGE_BACKEND},JVM_WEEKLY_DATABASE_URL=${JVM_WEEKLY_DATABASE_URL},JVM_WEEKLY_DATABASE_USER=${JVM_WEEKLY_DATABASE_USER},JVM_WEEKLY_FIREBASE_PROJECT_ID=${JVM_WEEKLY_FIREBASE_PROJECT_ID},JVM_WEEKLY_ALLOWED_ORIGINS=${JVM_WEEKLY_ALLOWED_ORIGINS}" \
