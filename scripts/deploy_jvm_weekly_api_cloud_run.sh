...
DEFAULT_INTERNAL_API_TOKEN_ENABLED="false"
if [[ "$PROJECT_ID" == "$STAGE_GCP_PROJECT_ID" ]]; then
  DEFAULT_INTERNAL_API_TOKEN_ENABLED="true"
fi
JVM_WEEKLY_INTERNAL_API_TOKEN_ENABLED="${JVM_WEEKLY_INTERNAL_API_TOKEN_ENABLED:-$DEFAULT_INTERNAL_API_TOKEN_ENABLED}"
