...
JVM_WEEKLY_CASHFLOW_SETTLED_WEEK_CONFIRMATION_KEY_SECRET="${JVM_WEEKLY_CASHFLOW_SETTLED_WEEK_CONFIRMATION_KEY_SECRET:-innerplatform-cashflow-settled-week-confirmation-key}"
...
gcloud run deploy "$STAGE_SERVICE_NAME" \
  ...
  --set-secrets "JVM_WEEKLY_INTERNAL_API_TOKEN=${JVM_WEEKLY_INTERNAL_API_TOKEN_SECRET}:latest,JVM_WEEKLY_CASHFLOW_SETTLED_WEEK_CONFIRMATION_KEY=${JVM_WEEKLY_CASHFLOW_SETTLED_WEEK_CONFIRMATION_KEY_SECRET}:latest"
