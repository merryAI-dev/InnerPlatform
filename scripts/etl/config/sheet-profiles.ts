...
export const SHEET_PROFILES: SheetProfile[] = [
  ...
  { namePattern: 'cashflow(사용내역 연동)', targetCollection: 'cashflow_weeks', hint: '주차별 입출금. 행=항목, 열=주차(68열). 병합셀 63개', headerRowCount: 6, dataStartRow: 7 },
  { namePattern: 'cashflow(e나라도움', targetCollection: 'cashflow_weeks', hint: 'e나라도움 전용 cashflow', headerRowCount: 6, dataStartRow: 7 },
  ...
  { namePattern: '그룹cashflow', targetCollection: 'cashflow_weeks', hint: '그룹 사업 cashflow', headerRowCount: 4, dataStartRow: 5 },
