...
![overview](https://github.com/user-attachments/assets/3edc1fa9-125b-46ad-978c-be988404f84a)

**일시:** 2026년 3월 5일 (목) AM 10:30 ~ 11:30 (60분)
**장소:** 7층 회의실 
**why:** 
검증 포인트 : 참석자 분들이 돌아가셔서 다운로드 해주고 전파하기 위해서 지금 프로그램에서 그간에 공유되지 못한(해소되어야 할)문제는? - AXR의 가설 기반으로 만들어짐 
1)그룹/실 간 사용할 프로그램에 대해서 선제적으로 공유
2)그간의 암묵지/페인포인트 공유를 통해서 추가 개발 지점 논의가 더욱 핵심
3)디테일한 사용성과 추가 구현 대해서는 이후 슬랙을 통해 검증하고 우선 순위 논의 
---
...
- AXR QA 등록 방법
- 전체 의견 수렴을 위해서, 실시간으로 개발 진행/반영여부를 업데이트 하기 위함 
