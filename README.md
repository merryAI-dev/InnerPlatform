...
개발 배경 : 그간 시트에서 관리할 때 **1.(모니터링 관점)작성 여부에 대해 교차검증이 불가능했고** **2.(자산화 측면)사업비 활용/반려에 대해서 암묵지들을 축적되지 못하는 동시에** **(표준화)3)사업별 양식 변경/파편화로 인해 오류가 나거나 전사적으로는 중요 거래 건에 대해서도 누락이 발생하는 문제가 있었습니다.** 

문서 목적 : 기술 설명보다 **어느 화면에서 무엇을 확인하고**, **무엇은 시스템이 해주고**, **무엇은 내가 판단해야 하는지**를 이해하는 데 집중해요.
...
기존 시트와 용어는 100% 동일한데 향후 온보딩 자료로 활용하기 위해서 설명하고 진행합니다.  
