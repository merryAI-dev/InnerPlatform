...
This project is indexed by GitNexus as **InnerPlatform-ft-izzie-latest** (2382 symbols, 6899 relationships, 180 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
